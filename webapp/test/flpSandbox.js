		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Navigation",
									"targetURL": "#zbtpday6exercise1mangsat-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zbtpday6exercise1mangsat-display": {
								"semanticObject": "zbtpday6exercise1mangsat",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zbtp.day6exercise1mangsat",
									"url": sap.ui.require.toUrl("zbtp/day6exercise1mangsat")
								}
							}
						}
					}
